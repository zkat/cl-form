(cl:defpackage #:cl-form.test
  (:use :cl :alexandria :eos :cl-form))
(cl:in-package #:cl-form.test)
  ...
  (flet ((always-error (val)
    ...
    (deform test-form ()
      ((whatever #'identity)
       ...
       (int-field #'as-int)
       ((my-list list) #'identity)
       ((my-array array) #'identity)))
    (let ((form (make-form 'test-form '(("whatever" . "a")
      ...
      (is (equalp '("one" "two") (field-raw-value form 'my-list)))
      (is (equalp #("0" nil nil nil nil "5") (field-raw-value form 'my-array))))))
...
(test field-value
  (flet ((always-error (val)
    ...
    (let ((form (make-form 'test-form '(("whatever" . "a")
      ...
      (is (equal '(1 2) (field-value form 'my-list)))
      (is (equalp #("0" "5") (field-value form 'my-array))))))
